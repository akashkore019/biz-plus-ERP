          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-center">
            ...
            <div>
              <div
                ...
                style={{
                  boxShadow:
                    'inset 15px 15px 30px rgba(0, 0, 0, 0.2), inset -15px -15px 30px rgba(0, 0, 0, 0.2), inset 0 15px 30px rgba(0, 0, 0, 0.2), inset 0 -15px 30px rgba(0, 0, 0, 0.2)',
                }}
              >
                {/* Video Placeholder */}
                <div className="w-full h-full flex items-center justify-center">
                  <div
                    ...
                    onMouseEnter={(e) =>
                      (e.target.style.backgroundColor = '#032d5e')
                    }
                    onMouseLeave={(e) =>
            ...
            <div>
              <div className="flex items-start gap-3 mb-6 justify-center">
                {/* Left Quote */}
                <svg
                  className="w-10 h-10 sm:w-12 sm:h-12 lg:w-16 lg:h-16 transform rotate-180 relative -top-4"
                  style={{ color: '#043873' }}
                  fill="currentColor"
                  viewBox="0 0 24 24"
                >
                ...
                {/* Heading */}
                <h2
                  className="text-3xl sm:text-4xl lg:text-5xl font-bold text-center leading-tight flex-1"
                  style={{ color: '#043873' }}
                >
                ...
                {/* Right Quote */}
                <svg
                  className="w-10 h-10 sm:w-12 sm:h-12 lg:w-16 lg:h-16 relative -top-3"
                  style={{ color: '#043873' }}
                  fill="currentColor"
                  viewBox="0 0 24 24"
                >
              ...
              <p className="text-gray-400 text-base sm:text-lg mb-8 leading-relaxed text-center">
            ...
            <div className="text-center">
              ...
              <div className="text-gray-600 text-base sm:text-lg mb-8 leading-relaxed max-w-3xl mx-auto">
                <p className="mb-4">
                  ...
                  create stunning, professional websites that look amazing on
                  any device. With built-in responsive design features and
                  optimized assets, your content will always appear crisp and
                  clear.
                </p>
                <p className="mb-4">
                  We've carefully crafted every component to ensure
                  pixel-perfect rendering on high-resolution displays. From
                  typography to images, everything is optimized for retina
                  screens, giving your users the best possible viewing
                  experience.
                </p>
                <p>
                  Join thousands of satisfied customers who have already
                  discovered the power of our framework. Start building
                  beautiful, modern websites today and see the difference that
                  quality design makes.
                </p>
              </div>
